...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # where the staticfiles goes on running collectstatic
...
## turn to false if running locally without docker/https
